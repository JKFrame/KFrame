...
<html>
  ...
  <body>
    ...
    <?php content_generico('pre_content_generico','¿Quiénes Somos?','slider0.jpg',$datos_individual);?>
    <div class="contenedor_quienes_somos">
      <div class="contenedor_equipo">
        <span class="titulo_trastornos">Equipo</span>
    ...
    <div class="contenido_quienes_somos">
      ...
      <!--<div class="contenedor_trastornos">
        <span class="titulo_trastornos">¿Qué es un Trastorno Adictivo?</span>
        <p>
    ...
    <div class="contenedor_ofrecemos">
      <span class="titulo_ofrecemos">¿Qué ofrecemos?</span>
      <ul class="lista_ofrecemos">
        ...
        <li><i class="fa fa-circle" style="color:#3399CC;  margin-right:10px;  font-size:18px;"aria-hidden="true"></i><span>Programa de Tratamiento sin Demanda, brindamos asesoramientos para aquellos casos en los que no exista motivación por parte de la persona <span class="acomodar_texto">afectada para realizar el tratamiento y acuda la familia.</span></span></li>
        ...
        <li><i class="fa fa-circle" style="color:#3399CC;  margin-right:10px;  font-size:18px;"aria-hidden="true"></i>Tratamiento Integrativo del Paciente Dual (trastornos adictivos y psiquiátricos) cuando se determine que el programa pueda ser beneficioso según el <span class="acomodar_texto">perfil del paciente y la familia.</span></li>
